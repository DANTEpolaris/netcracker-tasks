 ...
 * в методе {@link #getBusinessCard(java.util.Scanner)}.<br/>
 * Большинство методов должны просто возвращать считанные через {@link java.util.Scanner} значения.<br/>
 * Расчет возраста по дате рождения может проводиться в методе {@link #getAge()}
 * - необязательно это делать сразу в {@link #getBusinessCard(java.util.Scanner)}).<br/>
 *
